...
### Page des astres
Il s'agit de la page principal du site qui se charge d'afficher la liste de toutes les planètres du Système Solaire récupérer au préalable . Sur cette page, il est possible d'ajouter/enlever un astre de ses favoris ou bien d'accéder au détail de celui-ci en cliquant sur la carte correspondante.
